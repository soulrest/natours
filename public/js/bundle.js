...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.114454, 34.112309],
    // zoom: 3.5,
    // interactive: false
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in seccessfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // location.reload(true) - перегрузить сторінку з сервера, а не кеш браузера.
            // посуті, загрузить сторінку по новому з сервера
            if (res.data.status === 'success') {
...
var stripe = Stripe('pk_test_51GxaamGqFE1mu3HAjQTMBGSvNBH3GDDv0Bl7siwAiVNPcIScaicGtcmG7N1RiuJLRoUqECzJ7kPgd8ZixoIgaPw400OevlzcVK');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // даний спосіб з new FormData() із append - використовуємо якщо форма включає в себе файл(фото, тощо)
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //  оскільки updateSettings повертає промис, то являється аснхронною і ми можемо використовувати на ній async/await
